...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        await interaction.guild.channels
            ...
            .then(async (channel) => {
                const attachment = new AttachmentBuilder("./settings/images/banner.png", {
                    name: "setup.png",
                });
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(
                        `>>> [Invite](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=2184310032&scope=bot%20applications.commands) | [Support](https://discord.gg/SNG3dh3MbR) | [Website](https://adivise.github.io/Stylish/)`,
                    )
